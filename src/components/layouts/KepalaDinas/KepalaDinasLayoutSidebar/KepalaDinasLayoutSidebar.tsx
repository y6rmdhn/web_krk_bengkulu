...
import useKepalaDinasLayout from "../useKepalaDinasLayout";
...
const KepalaDinasLayoutSidebar = (props: PropsType) => {
  const { isOpen, sidebarItems = [], onClose } = props;
  const navigate = useNavigate();
  const location = useLocation();
  const { handleLogout } = useKepalaDinasLayout();
      ...
      >
        <div className="w-full relative">
          ...
          <div className="flex w-full justify-center items-center mb-8 gap-3 mt-2 lg:mt-0">
            ...
            />
            <p className="text-lg font-bold text-gray-800">Kepala Dinas</p>
          </div>
