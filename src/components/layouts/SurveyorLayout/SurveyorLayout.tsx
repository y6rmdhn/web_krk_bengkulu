...
import { SIDEBAR_ADMIN } from "./SurveyorLayout.constan";
...
const SurveyorLayout = (props: PropsType) => {
            ...
            <div className="flex justify-between items-center">
              ...
              {/* <div className="flex items-center gap-3">
                <div className="flex flex-col items-end">
                  <h3 className="text-sm font-bold text-gray-800">Surveyor</h3>
