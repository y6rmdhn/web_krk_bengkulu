...
import usePermohonanSkTTE from "./useSKTTELainnya";
...
const PermohonanSkTTE = () => {
  ...
  return (
    <KepalaDinasLayout
      title="Permohonan Sk Lainnya | KRK Kota Bengkulu"
      desc="Permohonan Sk Lainnya"
    >
          ...
          <CardHeader>
            <div className="flex justify-between items-center">
              <h1 className="text-lg font-semibold">
                Daftar SK TTE Lainnya ({filteredResult.length})
              </h1>
            </div>
          </CardHeader>
          <CardContent>
